...
Este repositorio contiene el proyecto final desarrollado para la asignatura de Estructura de Computadores, Paralelismo y Sistemas Distribuidos del Grado en Ciberseguridad impartido en EUNEIZ. El objetivo del proyecto es construir y optimizar un clúster MPI para minería distribuida
